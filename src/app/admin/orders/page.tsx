...
type OrderStatusValue = 'PENDING' | 'PROCESSING' | 'SHIPPED' | 'DELIVERED' | 'CANCELLED' | 'REFUNDED'
...
export default function AdminOrdersPage() {
  ...
  const handleStatusUpdate = async (orderId: string, newStatus: OrderStatusValue) => {
    try {
  ...
  const handleBulkStatusUpdate = async (newStatus: OrderStatusValue) => {
              ...
              <form onSubmit={handleSearch} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <select
                      value={statusFilter}
                      onChange={(e) => setStatusFilter(e.target.value as OrderStatusValue | '')}
                          ...
                          <tr key={order.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center space-x-2">
                                ...
                                <select
                                  value={order.status}
                                  onChange={(e) => handleStatusUpdate(order.id, e.target.value as OrderStatusValue)}
